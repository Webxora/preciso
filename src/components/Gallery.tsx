  ...
  const filteredImages =
    selectedFilter === "all"
      ...
      : galleryImages.filter((image) =>
          image.categories.includes(selectedFilter)
        );
        ...
        <ScrollReveal>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl mb-4">
              Coffee Moments Captured
            </h2>
            <p className="text-zinc-600">
              Explore our vibrant collection of coffee moments, from bean to
              cup, capturing the essence of our passion for exceptional coffee.
            </p>
          </div>
        </ScrollReveal>
