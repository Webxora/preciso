...
//     if (!isWebGLSupported()) {
//       console.warn(
//         "WebGL is not supported in this browser. Falling back to static content."
//       );
//       setIsLoading(false);
//       return;
//     }
...
//     const coffeeShineGeometry = new THREE.CircleGeometry(
//       cupTopRadius - cupThickness - 0.01,
//       32
//     );
...
//       opacity: 0.6,
//     });
//     const coffeeShine = new THREE.Mesh(
//       coffeeShineGeometry,
//       coffeeShineMaterial
//     );
...
//       points.push(
//         new THREE.Vector3(offsetX * 0.3, cupHeight / 2 - 0.05, offsetZ * 0.3)
//       );
...
//           const xOffset =
//             Math.sin(elapsedTime * xSinFreq + t * 8 + phaseOffset) *
//             0.05 *
//             heightFactor;
//           const zOffset =
//             Math.cos(elapsedTime * zCosFreq + t * 6 + phaseOffset) *
//             0.05 *
//             heightFactor;

//           // Higher frequency subtle details
//           const detailX =
//             Math.sin(elapsedTime * 3 + t * 15 + phaseOffset * 2) *
//             0.02 *
//             heightFactor;
//           const detailZ =
//             Math.sin(elapsedTime * 2.5 + t * 12 + phaseOffset * 2) *
//             0.02 *
//             heightFactor;
...
//             originalPoint.y +
//               Math.sin(elapsedTime * 0.5 + phaseOffset) * 0.02 * heightFactor, // Subtle vertical movement
...
//             0,
//             1 - Math.max(0, topPointY - fadeHeight) / 0.7
//           );
...
//                 className="w-full h-full text-coffee-cream"
//               >
//                 <path
//                   d="M2 8H16.5C17.3284 8 18 8.67157 18 9.5V9.5C18 10.3284 17.3284 11 16.5 11H11.5"
//                   stroke="currentColor"
//                   strokeWidth="1.5"
//                   strokeLinecap="round"
//                 />
//                 <path
//                   d="M5 11H10.5C11.3284 11 12 11.6716 12 12.5V12.5C12 13.3284 11.3284 14 10.5 14H6"
//                   stroke="currentColor"
//                   strokeWidth="1.5"
//                   strokeLinecap="round"
//                 />
//                 <path
//                   d="M9 14H11.5C12.3284 14 13 14.6716 13 15.5V15.5C13 16.3284 12.3284 17 11.5 17H9"
//                   stroke="currentColor"
//                   strokeWidth="1.5"
//                   strokeLinecap="round"
//                 />
//                 <path
//                   d="M18 9.00003C19.2144 9.4791 20 10.6108 20 12C20 13.3892 19.2144 14.5209 18 15"
//                   stroke="currentColor"
//                   strokeWidth="1.5"
//                   strokeLinecap="round"
//                 />
...
//                   fillRule="evenodd"
//                   clipRule="evenodd"
//                   d="M4 8C2.89543 8 2 7.10457 2 6V5C2 3.89543 2.89543 3 4 3H16C17.1046 3 18 3.89543 18 5V6C18 7.10457 17.1046 8 16 8H4Z"
//                   stroke="currentColor"
//                   strokeWidth="1.5"
//                 />
//                 <path
...
//               Experience our specialty coffee with the finest beans
//             </p>
//           </div>
//         </div>
//       )}
...
//             />
//             <path
//               d="M16.9497 7.05025C17.3403 6.65973 17.3403 6.02656 16.9497 5.63604C16.5592 5.24551 15.9261 5.24551 15.5355 5.63604C15.145 6.02656 15.145 6.65973 15.5355 7.05025C15.9261 7.44077 16.5592 7.44077 16.9497 7.05025Z"
//               fill="currentColor"
//             />
//             <path
//               d="M8.46446 15.5355C8.85499 15.145 8.85499 14.5118 8.46446 14.1213C8.07394 13.7308 7.44077 13.7308 7.05025 14.1213C6.65973 14.5118 6.65973 15.145 7.05025 15.5355C7.44077 15.9261 8.07394 15.9261 8.46446 15.5355Z"
//               fill="currentColor"
//             />
//             <path
//               d="M16.9497 16.9497C17.3403 16.5592 17.3403 15.9261 16.9497 15.5355C16.5592 15.145 15.9261 15.145 15.5355 15.5355C15.145 15.9261 15.145 16.5592 15.5355 16.9497C15.9261 17.3403 16.5592 17.3403 16.9497 16.9497Z"
//               fill="currentColor"
//             />
//             <path
//               d="M8.46446 8.46446C8.85499 8.07394 8.85499 7.44077 8.46446 7.05025C8.07394 6.65973 7.44077 6.65973 7.05025 7.05025C6.65973 7.44077 6.65973 8.07394 7.05025 8.46446C7.44077 8.85499 8.07394 8.85499 8.46446 8.46446Z"
//               fill="currentColor"
//             />
//           </svg>
